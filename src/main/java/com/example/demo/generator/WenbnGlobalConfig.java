...
public class WenbnGlobalConfig extends GlobalConfig {
    ...
    public WenbnGlobalConfig setManagerName(String managerName) {
        this.managerName = managerName;
        return this;
    }

    public WenbnGlobalConfig setManagerImplName(String managerImplName) {
...
//        int PRIME = true;
        ...
        Object $managerName = this.getManagerName();
        result = result * 59 + ($managerName == null ? 43 : $managerName.hashCode());
        Object $managerImplName = this.getManagerImplName();
        result = result * 59 + ($managerImplName == null ? 43 : $managerImplName.hashCode());
